...
class _MyTeamScreenState extends State<MyTeamScreen>
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                return myteam_item_widget(
                  ...
                  onTap: () => _viewModel.selectTeam(index, isEnrolled),
  ...
  List<Widget> _buildAllCategorySections(String playerImage, Color sportColor) {
    ...
    if (categories.isEmpty) {
      ...
      return [
        _buildAllPlayersSection(totalMaxPlayers, playerImage, sportColor)
      ];
    }
    ...
    for (int i = 0; i < categories.length; i++) {
      ...
      sections.add(_buildCategorySection(
          category, maxPlayers[category] ?? 0, playerImage, sportColor));
  ...
  Widget _buildAllPlayersSection(
      int maxPlayers, String playerImage, Color sportColor) {
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            if (index < players.length) {
              return _buildPlayerCard(players[index], playerImage, sportColor);
            } else {
  ...
  Widget _buildCategorySection(
      String category, int maxPlayers, String playerImage, Color sportColor) {
  ...
  Widget _buildPlayerCard(
      PlayerModel player, String playerImage, Color sportColor) {
    final sport = _viewModel.preferredSport;
