...
class LeatherLeaderboardFrag extends StatefulWidget {
  const LeatherLeaderboardFrag({super.key});

  @override
  _LeatherLeaderboardFragState createState() => _LeatherLeaderboardFragState();
}

class _LeatherLeaderboardFragState extends State<LeatherLeaderboardFrag> {
