import 'dart:async';
import 'package:cricyard/views/screens/MenuScreen/Matches/tour_graphs/tour_graph_service.dart';
...
class TournamentScoreGraph extends StatefulWidget {
  final int matchId;
  TournamentScoreGraph({Key? key, required this.matchId}) : super(key: key);

  @override
  State<StatefulWidget> createState() => TournamentScoreGraphState();
}

class TournamentScoreGraphState extends State<TournamentScoreGraph> {
  final TourGraphService _graphService = TourGraphService();
