...
class _MyfollowingscreenState extends State<Myfollowingscreen> {
    ...
    return Column(
      children: [
        ...
        _buildTitleRowWidget(
            title1: 'Playing XI $team',
            subtitle1: '',
            title2: '',
            title3: '',
            subtitle2: '',
            subtitle3: ''),
        _buildPlayerImgRowWidget(
            imgPath1: ImageConstant.imgImage51,
            imgPath2: ImageConstant.imgImage51,
            imgPath3: ImageConstant.imgImage51),
        const Divider(
          color: Colors.grey,
        ),
        _buildTitleRowWidget(
  ...
  Widget _buildPlayerImgRowWidget(
    ...
    return SizedBox(
      ...
      child: Row(
        children: [
          Expanded(child: Image.asset(imgPath1)),
          Expanded(child: Image.asset(imgPath2)),
          imgPath3.isEmpty
              ? Container()
              : Expanded(child: Image.asset(imgPath3)),
        ],
      ),
    );
  }
