...
class ExpandableScoreboardContainer extends StatefulWidget {
  final Map<String, dynamic> data;
  final List<Map<String, dynamic>> fallOfWicket;
  const ExpandableScoreboardContainer({super.key, required this.data, required this.fallOfWicket});

  @override
  State<ExpandableScoreboardContainer> createState() =>
      _ExpandableScoreboardContainerState();
}

class _ExpandableScoreboardContainerState
    extends State<ExpandableScoreboardContainer> {
  ...
  Widget _buildPlayerDetails(List<dynamic> players) {
    ...
    List<dynamic> batsmen = players.where((player) => player != null && player['player_type'] == 'Batsman').toList();
    List<dynamic> bowlers = players.where((player) => player != null && player['player_type'] == 'Baller').toList();
          ...
          TableRow(
            children: [
              _buildTableCell("${player["player_name"]}\n${player["out_type"]}",
                  isHeader: false),
              _buildTableCell(player["total_run"].toString(), isHeader: false),
              _buildTableCell(player["total_ball"].toString(), isHeader: false),
        ...
        children: [
          TableRow(
            children: [
              ...
              _buildTableCell(player["current_match_over"].toString(), isHeader: false),
              _buildTableCell(player["current_match_maidan_over"].toString(), isHeader: false),
              _buildTableCell(player["current_match_run"].toString(),
                  isHeader: false),
              _buildTableCell(player["current_match_wicket"].toString(),
                  isHeader: false),
              _buildTableCell(player["current_match_economy_rate"].toString(),
                  isHeader: false),
            ],
          ),
        ],
