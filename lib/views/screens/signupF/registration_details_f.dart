import 'package:cricyard/views/screens/sign_up_screen/choose_package_screen.dart';
                        ...
                        : () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              try {
                                ...
                                final accountResponse = await userService
                                    .createAccount(accountformData);

                                if (accountResponse == null ||
                                    accountResponse['account_id'] == null) {
                                  throw Exception('Failed to create account');
                                }

                                account_id =
                                    accountResponse['account_id'].toString();
